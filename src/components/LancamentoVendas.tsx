...
<head>
  ...
  <style>
    @page { margin: 0; }
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: 'Courier New', Courier, monospace; font-size: 12px; width: 68mm; margin: 0 auto; padding: 4mm 0; line-height: 1.5; color: black; }
    ...
    @media print { @page { margin: 0; } body { width: 68mm; } }
  </style>
</head>
<body>
  <div class="center">
